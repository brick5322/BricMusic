...
ArgSplitter::ArgSplitter(int argc, char** argv) :ARGC(argc), ARGV(argv), _argv(new char* [argc]), long_options(nullptr), arg_options(nullptr), arg_type(new Type[argc]), _arg_type((Type*)arg_type)
{
}
